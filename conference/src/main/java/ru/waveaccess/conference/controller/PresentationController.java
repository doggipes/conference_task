...
public class PresentationController {
    ...
    public String postUpdatePresentationController(Model model, @PathVariable Long id, String name){
    ...
    public String postAddPresenterPresentationController(Model model, @PathVariable Long id, Authentication authentication){
        UserDetailsImpl userDetails = (UserDetailsImpl) authentication.getPrincipal();
        User user = userDetails.getUser();
